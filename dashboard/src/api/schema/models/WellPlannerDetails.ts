...
import type { WellPlannerBaseline } from './WellPlannerBaseline';
...
import type { WellPlannerEmissionManagementPlan } from './WellPlannerEmissionManagementPlan';
...
export type WellPlannerDetails = {
    ...
    baseline: WellPlannerBaseline;
    emission_management_plan: WellPlannerEmissionManagementPlan | null;
    /**
     * Asset fuel type
     */
    fuel_type: string;
