...
import type { WellEmissionReduction } from '../models/WellEmissionReduction';
...
export class TenantsService {
    ...
    public static tenantsEmissionsMaterialTypesAllList(
        tenantId: number,
    ): CancelablePromise<Array<MaterialTypeList>> {
        return __request(OpenAPI, {
            method: 'GET',
    ...
    /**
     * Well target CO2 emission reductions
     * @param tenantId
     * @param wellPlannerId
     * @returns WellEmissionReduction
     * @throws ApiError
     */
    public static tenantsEmissionsWellsPlannedEmissionsTargetReductionsCo2List(
        tenantId: number,
        wellPlannerId: number,
    ): CancelablePromise<Array<WellEmissionReduction>> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/tenants/{tenant_id}/emissions/wells/{well_planner_id}/planned/emissions/target/reductions/co2/',
            path: {
                'tenant_id': tenantId,
                'well_planner_id': wellPlannerId,
            },
