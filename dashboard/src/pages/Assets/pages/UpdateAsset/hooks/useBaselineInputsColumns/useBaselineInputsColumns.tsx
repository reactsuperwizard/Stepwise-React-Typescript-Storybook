...
import useSeasonValues from '../useSeasonValues';
...
const useBaselineInputsColumns = (season: Season) => {
  ...
  const { duplicatePhase, removePhase, removeMode, updatePhase } =
    useUpdateBaselineInput();
  const { modes, phases } = useSeasonValues(season);
