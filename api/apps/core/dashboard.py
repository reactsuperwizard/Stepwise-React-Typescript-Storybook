...
class DashboardRoutes:
    ...
    projectUpdateRig = '/dashboard/prepare/projects/{projectId}/rigs/{rigType}/{rigId}/update/'
    ...
    updateProjectWell = '/dashboard/prepare/projects/{projectId}/wells/{wellId}/update/'
    ...
    createEMP = '/dashboard/prepare/projects/{projectId}/rigs/{rigType}/{rigId}/emp/create/'
    updateEMP = '/dashboard/prepare/projects/{projectId}/rigs/{rigType}/{rigId}/emp/update/'
    signin = '/signin/'
    search = '/dashboard/search/{query}/'
    changeForgottenPassword = '/forgot-password/{uid}/{token}/'
    invitation = '/invitation/{token}/'
    createWellPlan = '/dashboard/prepare/well-plans/create/'
    updateWellPlanStep = '/dashboard/prepare/well-plans/{wellPlanId}/{stepId}/'
    updateWellPlan = '/dashboard/prepare/well-plans/{wellPlanId}/'
    wellPlaneReport = '/reports/well-plans/{wellPlanId}/'
    assets = '/dashboard/emissions/drilling-and-well/assets/'
    createAsset = '/dashboard/emissions/drilling-and-well/assets/create/'
    updateAsset = '/dashboard/emissions/drilling-and-well/assets/{assetId}/update/'
